...
public class ShaderInjector
{
    ...
    private static readonly Regex GeneratedRegex =
        new Regex("^\\s*#\\s*generated\\s+(.*)$", RegexOptions.IgnoreCase | RegexOptions.Multiline);

    private static readonly Regex SnippetRegex =
        new Regex("^\\s*#\\s*snippet\\s+(.*)$", RegexOptions.IgnoreCase | RegexOptions.Multiline);
    ...
    {
        get { return GeneratedValues[key]; }
