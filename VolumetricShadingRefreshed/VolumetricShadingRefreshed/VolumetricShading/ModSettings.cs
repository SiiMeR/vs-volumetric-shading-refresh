...
public static class ModSettings
{
    ...
    public static bool SSRTintInfluenceSet =>
        ClientSettings.Inst.Int.Exists("volumetricshading_SSRTintInfluence");
    ...
    public static bool SSRSkyMixinSet =>
        ClientSettings.Inst.Int.Exists("volumetricshading_SSRSkyMixin");
    ...
    public static bool DeferredLightingEnabledSet =>
        ClientSettings.Inst.Bool.Exists("volumetricshading_deferredLighting");

    public static bool DepthOfFieldEnabled
    {
        get => ClientSettings.Inst.GetBoolSetting("volumetricshading_depthOfField");
        set => ClientSettings.Inst.Bool["volumetricshading_depthOfField"] = value;
    }

    public static bool DepthOfFieldEnabledSet =>
        ClientSettings.Inst.Bool.Exists("volumetricshading_depthOfField");

    public static int DofFocusDepth
    {
        get => ClientSettings.Inst.GetIntSetting("volumetricshading_dofFocusDepth");
        set => ClientSettings.Inst.Int["volumetricshading_dofFocusDepth"] = value;
    }

    public static int DofBlurRange
    {
        get => ClientSettings.Inst.GetIntSetting("volumetricshading_dofBlurRange");
        set => ClientSettings.Inst.Int["volumetricshading_dofBlurRange"] = value;
    }
}