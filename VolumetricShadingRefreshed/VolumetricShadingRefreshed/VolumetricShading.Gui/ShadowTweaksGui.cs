...
public class ShadowTweaksGui : AdvancedOptionsDialog
{
    ...
    protected override void RefreshValues()
    {
        ...
        SingleComposer.GetSwitch("softShadowsEnabled").SetValue(ModSettings.SoftShadowsEnabled);
        SingleComposer.GetSlider("softShadowSamples").SetValues(ModSettings.SoftShadowSamples, 1, 64, 1);
