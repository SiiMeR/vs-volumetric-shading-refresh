...
public class ScreenSpaceReflectionsGui : AdvancedOptionsDialog
{
	...
	{
		GuiComposerHelpers.GetSwitch(((GuiDialog)this).SingleComposer, "toggleSSR").SetValue(ModSettings.ScreenSpaceReflectionsEnabled);
		GuiComposerHelpers.GetSwitch(((GuiDialog)this).SingleComposer, "toggleRefractions").SetValue(ModSettings.SSRRefractionsEnabled);
		GuiComposerHelpers.GetSwitch(((GuiDialog)this).SingleComposer, "toggleCaustics").SetValue(ModSettings.SSRCausticsEnabled);
		GuiComposerHelpers.GetSwitch(((GuiDialog)this).SingleComposer, "toggleRainReflections").SetValue(ModSettings.SSRRainReflectionsEnabled);
		GuiComposerHelpers.GetSlider(((GuiDialog)this).SingleComposer, "dimmingSlider").SetValues(ModSettings.SSRReflectionDimming, 1, 400, 1, "");
		GuiComposerHelpers.GetSlider(((GuiDialog)this).SingleComposer, "transparencySlider").SetValues(ModSettings.SSRWaterTransparency, 0, 100, 1, "");
		GuiComposerHelpers.GetSlider(((GuiDialog)this).SingleComposer, "tintSlider").SetValues(ModSettings.SSRTintInfluence, 0, 100, 1, "");
		GuiComposerHelpers.GetSlider(((GuiDialog)this).SingleComposer, "skyMixinSlider").SetValues(ModSettings.SSRSkyMixin, 0, 100, 1, "");
		GuiComposerHelpers.GetSlider(((GuiDialog)this).SingleComposer, "splashTransparencySlider").SetValues(ModSettings.SSRSplashTransparency, 0, 100, 1, "");
	}
