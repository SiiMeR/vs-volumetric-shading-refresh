...
public abstract class MainConfigDialog : GuiDialog
{
    ...
    protected void SetupDialog()
    {
        ...
        GuiComposer val7 = GuiComposerHelpers.AddDialogTitleBar(
            GuiComposerHelpers.AddShadedDialogBG(base.capi.Gui.CreateCompo("volumetricShadingConfigure", val), val6,
                true, 5.0, 0.75f), "Volumetric Shading Configuration", (Action)OnTitleBarCloseClicked, (CairoFont)null,
            (ElementBounds)null).BeginChildElements(val6);
        foreach (ConfigOption configOption in ConfigOptions)
        {
            ...
            {
                GuiComposerHelpers.AddSmallButton(val7, "Advanced...", configOption.AdvancedAction, val5,
                    (EnumButtonStyle)2, (string)null);
            }
