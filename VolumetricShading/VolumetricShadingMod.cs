...
public class VolumetricShadingMod : ModSystem
{
	...
	{
		CApi.Input.RegisterHotKey("volumetriclightingconfigure", "Volumetric Lighting Configuration", (GlKeys)85, (HotkeyType)2, false, true, false);
		CApi.Input.SetHotKeyHandler("volumetriclightingconfigure", (ActionConsumable<KeyCombination>)OnConfigurePressed);
	}
