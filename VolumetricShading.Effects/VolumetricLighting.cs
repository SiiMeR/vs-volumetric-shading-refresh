...
public class VolumetricLighting
{
	...
	public VolumetricLighting(VolumetricShadingMod mod)
	{
		...
		_dropShadowIntensityField = typeof(AmbientManager).GetField("DropShadowIntensity", BindingFlags.Instance | BindingFlags.NonPublic);
	...
	private void RegisterPatches()
	{
		...
		shaderInjector.RegisterFloatProperty("VOLUMETRIC_INTENSITY", () => (float)ModSettings.VolumetricLightingIntensity * 0.01f);
	}
