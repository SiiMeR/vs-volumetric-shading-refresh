...
public class OverexposureEffect
{
	...
	{
		mod.CApi.Settings.AddWatcher<int>("volumetricshading_sunBloomIntensity", (OnSettingsChanged<int>)OnSunBloomChanged);
	...
	private void RegisterInjectorProperties(VolumetricShadingMod mod)
	{
		...
		shaderInjector.RegisterFloatProperty("VSMOD_OVEREXPOSURE", () => (float)ModSettings.OverexposureIntensity * 0.01f);
